...
export default defineConfig({
  ...
  webServer: { command: 'node node_modules/vite/bin/vite.js src/renderer --host 127.0.0.1 --port 5175 --strictPort', url: 'http://127.0.0.1:5175', reuseExistingServer: false }
});
